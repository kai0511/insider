...
fit_interaction <- function(residual, train_indicator, cfd_indicators, column_factor, unique_cfd, lambda, alpha, tuning, tol = 1e-10, n_cores = 10L) {
    .Call(`_insider_fit_interaction`, residual, train_indicator, cfd_indicators, column_factor, unique_cfd, lambda, alpha, tuning, tol, n_cores)
}
